...
<p align="center">
  <img src="figures/CablePy_FlowChart.png" alt="CablePy Flowchart" width="65%">
</p>
...
- **Geometric Packing Solver:** Developed a solver for the "Smallest Enclosing Circle" problem to dynamically calculate bundle diameters. Implemented recursive splitting logic that triggers when a bundle diameter exceeds structural rib aperture limits.
